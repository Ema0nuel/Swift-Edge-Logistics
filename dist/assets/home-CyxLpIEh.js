import{F as d,N as r,s as p}from"./navbar-D_OOEgUD.js";import{s as g}from"./logo-BSIuJKwo.js";import{r as m}from"./reset-W7AGB0Zm.js";const i=["https://www.shipbob.com/wp-content/uploads/2023/10/2f854a399a4d8ac1b7b1aa7a78836549.png","https://www.shipbob.com/wp-content/uploads/2024/11/414d49e28e8fa74ca8e7604493adb78b.svg","https://www.shipbob.com/wp-content/uploads/2024/11/58136c17b9cbdfa9a8d9c4e3e6f597f4.svg","https://www.shipbob.com/wp-content/uploads/2022/04/Chamberlain_Coffee_Logo.png","https://www.shipbob.com/wp-content/uploads/2023/10/72ed96bf6febf9764415855386810276.png","https://www.shipbob.com/wp-content/uploads/2023/10/da85ba7fb0752aeb5d19bd292d70a232.png","https://www.shipbob.com/wp-content/uploads/2022/04/100_Thieveslogo_profile-bw.png","https://www.shipbob.com/wp-content/uploads/2024/11/2afc122e89b8fc6348a4d76fb63d5ef5.svg","https://www.shipbob.com/wp-content/uploads/2024/12/a117347e92ac840408db273df2792a98.png"],b=[{icon:"14003308f2bae5d8809dc2c8facd9b9d",title:"Inventory Distribution",desc:"Place inventory across different regions via one hub, with automated replenishment."},{icon:"3c5e2d0e5c7677643fc0807fcf2b5e8b",title:"Order Fulfillment",desc:"Best-in-class picking, packing, shipping, returns, and more across our network."},{icon:"bfea635b292017e2ece2b2dfdf8f3e12",title:"2-Day Shipping",desc:"Offer 2-day shipping for all sales channels across the country."},{icon:"6e897a380658d8bcaeb45bb3ec336868",title:"Customized Unboxings",desc:"Create an unforgettable unboxing experience to help your brand stand out."},{icon:"5d723db019cdcfc2c174abc7a1707596",title:"Warehouse Management",desc:"Track inventory across warehouses in real time and set reorder alerts."},{icon:"875a17ab7cb2afd1ac99ec61b586a6d5",title:"International Shipping",desc:"Ship to 250+ destinations with standard and expedited shipping options."},{icon:"32045388caf6e1a09c005e99943a08d0",title:"Global Fulfillment",desc:"Expand and scale across the world for an optimized supply chain."},{icon:"48f93226bd4bf7e47c8b12406037cd36",title:"B2B Fulfillment",desc:"Fulfill for retailers including automated EDI, online marketplaces, and more."},{icon:"e874fea6533d34d38af5ea24f6ab659f",title:"Integrations",desc:"Connect your ecommerce platform, sales channels, ERP, and other tools."}],f=[{title:"Health & Wellness",img:"6600337fbbec17538ad30748234b6bec.png",brands:["a2a5c4a45858492d8898ee355f7ef2f9-1.svg","6b9d6393009bf958b7f446c0e0538448-e1742835455805.png","4ab8b0fe910c5c38961854af99b5a41e.png","6ce43bdd6d2f5c6d17bbfa078177697f.png"],link:"/industries/health-wellness"},{title:"Beauty & Personal Care",img:"8124858de9ab1a89f2ae8a3e3c2ea143.png",brands:["20a4ca28de3eddf4ae11ece800484cc8.png","bbbc258f975e6acedd7d6857c581caa0.svg","72ed96bf6febf9764415855386810276.png","1eb602888f59ef3854e30accce66318a.png"],link:"/industries/beauty-personal-care"},{title:"Food & Beverage",img:"51b534faafb58f487d6ee21745fa0189.png",brands:["e83fe1b887dbb8776da2ee1cbc51c99d.png","883097f05ff2256dc7f6c485e28a6a59.png","ae0168cea02b2138502219f0cef49135.png","f9ece484519033e0ef034eb670fd6bae.png"],link:"/industries/food-beverage"},{title:"Apparel & Accessories",img:"7f5441c39a3485710c7c3e25ba325651.png",brands:["100_Thieveslogo_profile-bw.png","440c5b33660cf93ef9955c5383b67870.png","287425602fdf77753fc5f6476d8472da.png","dba488b00cfa177c21e107dbd5738596.png"],link:"/industries/apparel-accessories"}],h=[{quote:"Swift Logistics has transformed our delivery experience. Our customers are happier and our team is more efficient.",name:"Brian Herbstreit",position:"Owner, Nothing Bundt Cakes",logo:"https://www.dropoff.com/wp-content/uploads/2023/01/Logo_5.png",photo:"https://www.dropoff.com/wp-content/uploads/2022/11/S_3.png"},{quote:"We scaled our business with Swift Logistics and saw a 40% reduction in fulfillment costs.",name:"Ali Shahid",position:"COO, Our Place",logo:"https://www.shipbob.com/wp-content/uploads/2024/11/58136c17b9cbdfa9a8d9c4e3e6f597f4.svg",photo:"https://www.shipbob.com/wp-content/uploads/2024/11/58136c17b9cbdfa9a8d9c4e3e6f597f4.svg"},{quote:"Swift Logistics offers the best support and reliability for our growing brand.",name:"Stephanie Lee",position:"COO, PetLab Co.",logo:"https://www.shipbob.com/wp-content/uploads/2024/11/2afc122e89b8fc6348a4d76fb63d5ef5-1.svg",photo:"https://www.shipbob.com/wp-content/uploads/2024/11/2afc122e89b8fc6348a4d76fb63d5ef5-1.svg"}];function w(){const a=document.querySelector(".animated-logo-wall-track");if(!a)return;let s=0;function o(){s+=.5,a.style.transform=`translateX(-${s}px)`,s>a.scrollWidth/2&&(s=0),requestAnimationFrame(o)}o()}const k=()=>{m("Swift Edge Logistics");const{html:a,pageEvents:s}=r(),{html:o}=d();function l(){s(),w();let e=0;const t=document.querySelectorAll(".testimonial-item");t.length>0&&setInterval(()=>{t.forEach((n,c)=>n.classList.toggle("hidden",c!==e)),e=(e+1)%t.length},6e3)}return{html:`
        ...
        <main id="wcag-main-content" class="flex-1 flex flex-col justify-start items-stretch px-2 md:px-0">
          ...
          <section class="relative w-full bg-background-light dark:bg-background-dark mb-24">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-center text-center z-10 bg-black bg-opacity-40 pt-16">
              <img src="${p}" alt="SwiftEdge Logo" class="h-16 mb-4 block dark:hidden" />
              <img src="${g}" alt="SwiftEdge Logo" class="h-16 mb-4 hidden dark:block" />
          ...
          <section class="w-full bg-peach py-8 overflow-hidden">
            <div class="relative w-full h-20 flex items-center">
              <div class="animated-logo-wall-track flex gap-8 items-center" style="will-change: transform;">
                ${i.concat(i).map((e,t)=>`
                  <img src="${e}" alt="Brand Logo ${t}" class="h-12 w-auto rounded shadow transition-all duration-300" loading="lazy" />
                `).join("")}
              </div>
            </div>
            <style>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                ${b.map(e=>`
                  <div class="flex flex-col items-center text-center transition hover:scale-105">
                    <img class="h-16 mb-4" src="https://www.shipbob.com/wp-content/uploads/2024/12/${e.icon}.svg" alt="${e.title}">
          ...
          <section class="w-full bg-white dark:bg-background-dark py-12">
            <div class="container mx-auto px-2">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                ${f.map(e=>`
                  <div class="flex flex-col items-center text-center">
                    <img class="h-16 mb-4" src="https://www.shipbob.com/wp-content/uploads/2025/01/${e.img}" alt="${e.title}">
                    <h3 class="font-bold mb-2">${e.title}</h3>
                    <div class="flex flex-wrap justify-center gap-2 mb-2">
                      ${e.brands.map(t=>`<img class="h-8" src="https://www.shipbob.com/wp-content/uploads/2025/03/${t}" alt="">`).join("")}
                    </div>
          ...
          <section class="w-full bg-background-light dark:bg-background-dark py-12">
            <div class="container mx-auto px-2">
              ...
              <div class="flex flex-col items-center gap-8">
                ${h.map((e,t)=>`
                  <div class="testimonial-item${t===0?"":" hidden"} flex flex-col md:flex-row items-center gap-6 w-full transition-opacity duration-700">
                    <div class="flex-shrink-0 flex flex-col items-center">
                      <img class="h-16 w-16 rounded-full mb-2" src="${e.photo}" alt="${e.name}">
                      <img class="h-8" src="${e.logo}" alt="${e.position}">
                    </div>
                    <div class="flex-1 text-center md:text-left">
                      <blockquote class="italic text-text-subtle dark:text-peach mb-4">"${e.quote}"</blockquote>
                      <div>
                        <p class="font-bold">${e.name}</p>
                        <p class="text-sm">${e.position}</p>
                      </div>
                    </div>
                  </div>
                `).join("")}
          ...
          <section class="bg-white py-12">
            <div class="max-w-6xl mx-auto text-center">
              ...
              <div class="flex flex-wrap justify-center gap-6">
                ${["quest.png","sprinkles.png","labcorp-2.png","american-red-cross-2.png","mckesson.png","holt.png","texas-health.png","kpmg.png","helix.png","ricon.png","neiman.png","susie-cackes.png"].map((e,t)=>`
                  <img src="https://www.dropoff.com/wp-content/themes/bb-theme-child/media/clients-logos-svg/${e}" alt="brand ${t}" class="h-12">
                `).join("")}
              </div>
            </div>
          </section>
    ...
    `,pageEvents:l}};export{k as default};
//# sourceMappingURL=home-CyxLpIEh.js.map
