const t="/assets/page_not_found-DjLQOrvZ.svg",e=()=>({html:`
    <div class="flex flex-col items-center justify-center min-h-screen px-4 bg-background-light text-text-dark dark:bg-background-dark dark:text-text-light transition-colors duration-300">
      <img class="max-w-full mb-8 h-auto object-contain" alt="Page Not Found" src="${t}" />
  ...
  `});export{e as default};
//# sourceMappingURL=notfound-JzIHXVQK.js.map
