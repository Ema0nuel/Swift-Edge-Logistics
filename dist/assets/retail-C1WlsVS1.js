import{N as s,F as l}from"./navbar-D_OOEgUD.js";import{r as n}from"./reset-W7AGB0Zm.js";import"./logo-BSIuJKwo.js";const b=()=>{n("Retail");function i(){s().pageEvents();const a=document.querySelectorAll(".uabb-tab-link"),o=document.querySelectorAll(".section");a.forEach((e,r)=>{e.addEventListener("click",()=>{a.forEach(t=>t.parentElement.parentElement.classList.remove("uabb-tab-current")),e.parentElement.parentElement.classList.add("uabb-tab-current"),o.forEach((t,d)=>{t.classList.toggle("uabb-content-current",d===r)})})}),document.querySelectorAll(".uabb-faq-questions-button").forEach(e=>{e.addEventListener("click",()=>{e.classList.toggle("active"),e.nextElementSibling.style.display=e.classList.contains("active")?"block":"none"})})}return{html:`
...
//# sourceMappingURL=retail-C1WlsVS1.js.map
