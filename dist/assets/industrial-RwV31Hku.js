import{N as a,F as n}from"./navbar-D_OOEgUD.js";import{r as d}from"./reset-W7AGB0Zm.js";import"./logo-BSIuJKwo.js";const m=()=>{d("Industries");function o(){a().pageEvents();const s=document.querySelectorAll(".uabb-tab-link"),i=document.querySelectorAll(".section");s.forEach((e,r)=>{e.addEventListener("click",()=>{s.forEach(t=>t.parentElement.parentElement.classList.remove("uabb-tab-current")),e.parentElement.parentElement.classList.add("uabb-tab-current"),i.forEach((t,l)=>{t.classList.toggle("uabb-content-current",l===r)})})}),document.querySelectorAll(".uabb-faq-questions-button").forEach(e=>{e.addEventListener("click",()=>{e.classList.toggle("active"),e.nextElementSibling.style.display=e.classList.contains("active")?"block":"none"})})}return{html:`
...
//# sourceMappingURL=industrial-RwV31Hku.js.map
